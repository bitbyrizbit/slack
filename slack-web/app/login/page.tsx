        ...
        <div className="w-full max-w-[320px] mx-auto text-center flex flex-col items-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 w-full">
            ...
            <button
              ...
              className="w-full py-2.5 px-4 rounded-full bg-[var(--accent)] text-[var(--foreground)] font-semibold text-sm hover:bg-[#D5B98A] transition-all flex items-center justify-center gap-2"
            >
